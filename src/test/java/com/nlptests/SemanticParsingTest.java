...
public class SemanticParsingTest extends TestCase {
    ...
    public void testTokenRegExCreation () {
        CoreDocument doc = pe.parse(GILLARTTESTSTRING);
        System.out.println(doc.annotation());
    }

 //   public void PatternMatchTest(String regex ){
